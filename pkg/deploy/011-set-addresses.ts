...
const deployFn: DeployFunction = async (hre) => {
  ...
  const AddressDictator = await getContractFromArtifact(hre, names.unmanaged.AddressDictator, {
  ...
  await awaitCondition(
    async () => {
      return hexStringEquals(await Lib_AddressManager.owner(), AddressDictator.address);
    },
